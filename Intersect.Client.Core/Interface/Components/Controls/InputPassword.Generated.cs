//Code for Controls/InputPassword (Container)
using GumRuntime;
using MonoGameGum;
...
partial class InputPassword : MonoGameGum.Forms.Controls.PasswordBox
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Controls/InputPassword");
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new InputPassword(visual);
            return visual;
        });
        MonoGameGum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(InputPassword)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Controls/InputPassword", () => 
        {
    ...
    public InputPassword(InteractiveGue visual) : base(visual) { }
