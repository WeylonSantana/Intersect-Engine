//Code for Controls/Button (Container)
using GumRuntime;
using MonoGameGum;
...
partial class Button : MonoGameGum.Forms.Controls.Button
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new MonoGameGum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Controls/Button");
        ...
        ElementSaveExtensions.RegisterGueInstantiation("Controls/Button", () => 
        {
