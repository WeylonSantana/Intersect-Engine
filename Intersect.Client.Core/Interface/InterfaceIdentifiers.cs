...
public static partial class LoginIdentifiers
{
    public const string Title = "LoginTitleLabel";
    public const string UsernameLabel = "LoginUsernameLabel";
    public const string UsernameTextBox = "LoginUsernameTextBox";
    public const string PasswordLabel = "LoginPasswordLabel";
    public const string PasswordTextBox = "LoginPasswordTextBox";
    public const string SaveCredentials = "LoginSaveCredentialsCheck";
    public const string RegisterButton = "LoginRegisterButton";
    public const string LoginButton = "LoginButton";
    public const string ForgotPasswordButton = "LoginForgotPasswordButton";
    public const string SettingsButton = "LoginSettingsButton";
